<template>
        ...
        <div class="post-setting">
          <el-card :body-style="{ padding: '5px' }">
            ...
            <div class="setting-inner">
              ...
              <el-form-item label="板块" props="boardId">
                <el-cascader
                  placeholder="请选择板块"
                  :options="boardList"
                  :props="boardProps"
  ...
  const htmlEditorHeight = window.innerHeight - 80 - 135;
  const api = {
  ...
  const postHandler = () => {
    formDataRef.value.validate(async (valid) => {
      ...
      params.boardId = params.boardId[params.boardId.length - 1];
