<template>
  ...
  >
      ...
      <div class="user-side">
        ...
        <div class="user-extend-panel">
          <div class="info-item">
            ...
            <div v-else>{{ userInfo.currentIntegral }}</div>
          </div>
          <div class="info-item">
          ...
          <div class="info-item">
            <div class="label iconfont icon-user-filling" @click="showActive">
              活跃情况
            </div>
          </div>
        </div>
        ...
        <div class="article-list">
          ...
          >
            <template #default="{ data }">
              <ArticleListItem :data="data" :showEdit="activeTabName==0 && isCurrentUser" /> </template
          ></DataList>
        </div>
      </div>
    </div>
    ...
    <UserActive ref="userActiveRef"></UserActive>
  </div>
</template>
...
import UserActive from "@/views/ucenter/UserActive.vue";
...
//显示活跃情况
const userActiveRef = ref(null);
const showActive = () => {
  userActiveRef.value.showRecord();
};
watch(
